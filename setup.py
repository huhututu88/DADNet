...
if __name__ == '__main__':
    ...
    setup(
        name='dadnet',
        version=get_version(),
        description='DADNet: Dual-Attention U-Net for Industrial Surface Defect Segmentation',
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='DADNet Authors',
        author_email='TODO@example.com',
        keywords='computer vision, semantic segmentation, defect segmentation',
        url='https://github.com/<user>/DADNET',
